...
/**
 * The output boundary for creating an application use case.
 */
public interface CreateApplicationOutputBoundary {
    /**
     * Prepares the success view with the provided output data.
     *
     * @param outputData the output data to present in case of success.
     */
    void prepareSuccessView(CreateApplicationOutputData outputData);
